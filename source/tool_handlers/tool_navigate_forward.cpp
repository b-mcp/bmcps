...
static json handle_navigate_forward(const json &arguments) {
    (void)arguments;

    debug_log::log("navigate_forward invoked");
    browser_driver::DriverResult driver_result = cdp_driver::navigate_forward();
...
namespace tool_navigate_forward {
